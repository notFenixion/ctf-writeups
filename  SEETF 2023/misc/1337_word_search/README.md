...
Solved by modifying code from [here lol](https://github.com/James231/Wordsearch-Solver-Python/tree/master)
...
We can use this code while searching with the keyword ```"SEE{"```, since all flags contain this prefix.

We obtain the following output:
```[[484, 950], [485, 951], [486, 952], [487, 953]]```

After checking the letters in these coordinates, we realise that the flag starts from the coordinates (487, 953).

We can use the code below to output the reset of the characters in the flag:
```
s = ""
for i in range(50):
    s += wordsearch[487-i][953-i]
